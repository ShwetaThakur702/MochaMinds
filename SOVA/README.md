...
**Hackathon 2026 | Agent 02 | Rule-Based**
...
```
R1_REQUEST_DATE_FIELD=SO Submission Date   # Confirm via the official hackathon channel
R1_GAP_DAYS=30
...
## RM Contact
For KT and field clarifications: **the hackathon channel** via official hackathon channel.
